...
class BodyGameRuntime(object):
    ...
    def get_window_size(self):
        return (self._kinect.color_frame_desc.Width, self._kinect.color_frame_desc.Height)
...
def convert_to_coordinates(location, window_size):
    ...
    horizontal_coordinate = (x-width/2)*horizontal_factor
    vertical_coordinate = (y-height/2)*vertical_factor
...
while True:
    ...
    print(head_locations, window_size)